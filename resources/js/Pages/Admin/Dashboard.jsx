                    ...
                    <Card>
                        ...
                        <CardBody>
                            <div className="grid grid-cols-2 gap-3">
                                <button className="btn btn-block btn-primary" disabled title="Fitur akan segera tersedia">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5"
                                        fill="none"
                                ...
                                <button className="btn btn-block btn-outline" disabled title="Fitur akan segera tersedia">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        className="h-5 w-5"
                                        fill="none"
